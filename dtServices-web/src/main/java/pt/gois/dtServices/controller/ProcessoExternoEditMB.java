...
//	private ProcessoExternoSBLocal sb;
	...
	@EJB
	private pt.gois.dtServices.business.TipoEstadoSBLocal sbTiposDeEstado;
...
//			historico.setTipoObjeto(TipoEstadoSBLocal.PROCESSO_EXTERNO);
...
//		
//		return sbHistorico.findByObjectAndType(getId(), TipoEstadoSBLocal.PROCESSO_EXTERNO);
//	}
//
...
//				idEstadoAtual = TipoEstadoSBLocal.PE_CRIADO;
//				
//			}
//		}
